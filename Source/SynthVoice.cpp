...
void SynthVoice::update(const float fundType, const float fundGain, const float subGain, const float sawGain, const float attack, const float decay, const float sustain, const float release, const float volume)
{
    adsr.updateADSR(attack, decay, sustain, release);
    gain = volume;
    osc.updateControls(fundType, fundGain, subGain, sawGain);
}
